...
|---|---|---|---|
| [Senior Research Engineer, Model Evaluation](https://jobs.ashbyhq.com/cohere/cb5d588c-5637-423a-968b-bf637ee2caf9/) | Next-generation benchmarks, datasets, environments, evaluation methods, scalable analysis tooling, judge training, and evaluation efficiency | A versioned environment generator; machine-readable expected-change contracts; deterministic component metrics; hard gates; multilingual variants; analyzable failure records; preference-data export; 15-class one-field evaluator mutation assurance | Real-model leaderboard with uncertainty, expert validation, learned-judge experiments, positive equivalence classes, scaling and efficiency measurements |
...
|---|---|---|
| Paired environment | 18 deterministic groups and seven variants per group; 126 cases and 108 transformed pairs; digest-bound one-field mutation assurance | Larger compositional generator, hidden refreshed worlds, positive equivalence classes, contamination policy |
...
2. **Complete evaluator assurance:** the deterministic one-field mutation report now ships; add positive equivalence-class tests, finance-expert audit, disagreement analysis, and a documented metric-change process.
